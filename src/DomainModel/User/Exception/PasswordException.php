...
class PasswordException extends UserException
{
     ...
     */
    public static function weakPassword(AggregateId $userId): PasswordException
    {
        return new static(
     ...
     * @return PasswordException
     */
    public static function newPasswordEqualsWithCurrentPassword(AggregateId $userId): PasswordException
    {
        return new static(
